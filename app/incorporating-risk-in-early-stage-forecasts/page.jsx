    ...
    <div>
      {webinars.map((webinar, index) => (
        <div key={webinar.id || index}>
          <div className="flex mt-20  mx-auto flex-col justify-center md:flex-row">
            {/* Text Content Section */}
            <div className="forecastingwebinar max-w-[640px] text-black font-light">
              <h2 className="text-xl md:text-[40px] mb-4 leading-none text-black">
                {webinar.titleone}
              </h2>

              <p className="text-xl md:text-[24px] mb-4">{webinar.titletwo}</p>
            ...
            <div>
              <img
                src="/events/Frame-17-6.webp"
                alt={webinar.titlefour}
          ...
          <div className="font-sans text-[#2e2e2e]">
            ...
            >
              <div className="container mx-auto sm:px-0 px-3 py-12 md:py-16">
          ...
          <div ref={formRef} className="webinarvideo mt-15 mb-15 text-center">
            <h2 className="text-black text-[18px] pb-5 sm:text-[34px] font-light">
          ...
          <div className="mt-[20px] mb-[30px] sm::px-0 px-5 max-w-[1100px] mx-auto">
        ...
        <div className="h-full w-full fixed top-0 left-0 bg-[#00000080] z-50 flex justify-center items-center">
          <div className="relative w-[560px] bg-white shadow-lg rounded-lg p-8 flex flex-col items-center">
            ...
            <div className="bg-[#e0ffc7] border border-[#b4d39b] w-[500px] p-6 mx-auto flex flex-col items-center">
              ...
              <a
                href="https://www.youtube.com/embed/xuPOPs-v3BM"
                target="_blank"
