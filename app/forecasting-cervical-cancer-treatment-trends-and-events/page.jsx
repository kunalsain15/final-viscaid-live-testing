...
const page = () => {
  ...
  const webinars = [
    {
      id: 4,
      title: "Forecasting Cervical Cancer: Treatment, Trends, and Events",
      slug: "forecasting-cervical-cancer-treatment-trends-and-events",
      bgimageone: "/webinars/webinar-nurse.png",
      titlethree:
        "Cervical cancer continues to impose a significant burden on women, underscoring the importance of widespread awareness regarding prevention, screening, and treatment. Recent advancements show promise in addressing unmet needs. This webinar aims to increase awareness of the changing landscape in cervical cancer treatment, focusing on predicting the impact of key trends and events on product adoption.",
      ...
      about: {
        ...
        points: [
          ...
          "Reviewing key trends and market events​",
        ],
        image: "/webinars/Frame-scaled.webp",
      },
      forecasting: [
        { header: "Speaker" },
    ...
    <div>
      {webinars.map((webinar, index) => (
        <div key={webinar.id || index}>
          <div className="flex mt-20 flex-col-reverse md:grid md:grid-cols-12 ">
            {/* Text Content Section */}
            <div className="col-span-6 ">
              <div className="forecastingwebinar space-y-6  max-w-[610px] text-black font-light">
                <h2 className="text-2xl xl:text-[41px] sm:mt-0 mt-7 mb-4 xl:leading-[2.75rem]">
                  Forecasting Cervical Cancer: Treatment, Trends, and Events
                </h2>
                <p className="text-base text-[#63666A] leading-tight">
                  Cervical cancer continues to impose a significant burden on
                  women, underscoring the importance of widespread awareness
                  regarding prevention, screening, and treatment. Recent
                  advancements show promise in addressing unmet needs. This
                  webinar aims to increase awareness of the changing landscape
                  in cervical cancer treatment, focusing on predicting the
                  impact of key trends and events on product adoption.
                </p>
                <button
                  onClick={scrollToForm}
                  className="mt-6  cursor-pointer bg-[#BD302B] text-white font-sans font-light text-[18px] px-[23px] py-[7px] hover:bg-[#CF2E2E] transition-colors"
                  type="button"
                >
                  View Webinar
                </button>
            ...
            <div className="col-span-6 flex items-center justify-end">
              <img
                src={webinars[0].bgimageone}
                alt={webinars[0].title}
                className="w-full sm:border-none border-2 border-gray-200 h-[300px] sm:h-[400px] xl:h-[480px]"
              />
            </div>
          </div>
          ...
          <div ref={formRef} className="webinarvideo mt-15 mb-15 text-center">
            ...
            {webinar.webinarVideo.image ? (
              <img
                ...
                className="w-[731px] sm:px-0 px-10 h-[200px] sm:h-[481px] mx-auto cursor-pointer"
        ...
        <div className="h-full w-full fixed top-0 left-0 bg-[#00000080] z-50 flex justify-center items-center">
          <div className="relative w-[560px] bg-white shadow-lg rounded-lg p-8 flex flex-col items-center">
            ...
            <div className="bg-[#e0ffc7] border border-[#b4d39b] w-[500px] p-6 mx-auto flex flex-col items-center">
              ...
              <a
                href="https://www.youtube.com/embed/6hqXFnFt1CQ?si=7f04cUrOW3SUQoF2"
                target="_blank"
