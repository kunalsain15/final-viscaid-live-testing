      ...
      {events.map((event) => (
        <div key={event.id}>
          ...
          <div className="relative headevents mt-20 w-full flex flex-col-reverse sm:flex-row">
            <div className="relative sm:px-0 px-3 w-full sm:w-[100px] lg:w-[500px] xl:w-[69%] h-[200px] sm:h-[370px]">
              <div className="sm:absolute z-20 top-10 left-8 xl:left-10 flex flex-col items-start text-left logoeventsize">
                <img
                  src={event.logosize}
                  alt="event logo"
                  className="mb-4 mt-[30px] sm:mt-[40px] "
                />
            ...
            {/* Background Section */}
            <div className="relative z-10 w-full  h-[200px] sm:h-[370px]">
          ...
          {event.about && (
            <div className="font-sans sm:mt-0 mt-10 text-[#2e2e2e]">
              ...
              >
                <div className="container mx-auto px-5 lg:px-6 py-10 sm:py-12 md:py-16">
                  <div className="max-w-xl ml-auto text-left">
                    <h2 className="text-white text-xl sm:text-[32px] font-light leading-tight">
                      {event.about.title}
                    </h2>
                    <p className="mt-4 text-white font-light text-[15px] leading-[1.1]">
            ...
            <>
              ...
              <div className="grid grid-cols-1 xl:p-0 p-4 sm:grid-cols-2 md:grid-cols-4 mt-[20px] sm:mb-[30px] mb-[20px] gap-10 max-w-[1150px] mx-auto">
                    ...
                    <Link key={person.id} href={person.link}>
                      <div className="flex pb-3 hover:shadow-[0px_3px_6px_2px_rgba(0,_0,_0,_0.1)] flex-col items-center cursor-pointer">
                        <div className="relative w-full h-[260px] group overflow-hidden">
                          ...
                          />
                          <div className="absolute inset-0 bg-[#BD302BB3] bg-opacity-70 text-white p-5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-between">
                ...
                {event.agendaforecasting?.map((item, index) => (
                  ...
                  >
                    <a href="https://www.pmsa.org/conference/annual-conference/conference-agenda#agenda">
