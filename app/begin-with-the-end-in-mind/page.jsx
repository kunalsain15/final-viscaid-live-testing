  ...
  const webinars = [
    {
      ...
      bgimageone: "/webinars/Frame-47.webp",
      titleone: "Designing Demand Research to Drive the Forecast",
      titletwo: "Designing Demand Research to Drive the Forecast",
      titlethree:
        "Join us for an insightful webinar as we delve into the art and science of demand research, designed to empower your forecasting endeavors. Our webinar will equip you with essential strategies to align your demand research with your forecasting objectives.",
      ...
      about: {
        ...
        points: [
          "Aligning demand research methods with forecasting objectives​",
          "Using demand research to inform dynamic forecast modeling, multi-stakeholder integration, risk analyses and other advanced topics​",
          "Tips for avoiding common pitfalls, supercharging demand research for forecast success​",
        ],
        image: "/webinars/Frame-13-9-1536x415.png",
      },
      forecasting: [
        { header: "SPEAKERS" },
    ...
    <div>
      {webinars.map((webinar, index) => (
        <div key={webinar.id || index}>
          <div className="flex mt-20 flex-col-reverse justify-center mx-auto  md:flex-row">
            <div className="forecastingwebinar xl:pt-0 pt-8 md:max-w-[40%] xl:max-w-[46%] text-black font-light">
              <h3 className="text-2xl xl:text-[40px] text-black font-light mb-4">
                {webinar.title}
              </h3>
              <h3 className="text-xl xl:text-[28px] text-black font-light leading-8 mb-4">
                {webinar.titleone}
              </h3>
          ...
          <div className="font-sans text-[#2e2e2e]">
            <img
              src="/webinars/Frame-13-9-1536x415.png"
              className="w-full block sm:hidden h-[180px]"
            />
            <section
              key={webinar.id}
              className="relative h-[300px] md:min-h-[400px] bg-white bg-cover bg-no-repeat bg-right-top sm:bg-left-top flex items-center"
              style={{ backgroundImage: `url(${webinar.about?.image})` }}
            >
              <div className="container mx-auto py-0 md:py-16">
                <div className="max-w-2xl ml-auto sm:p-0 p-4 text-left">
        ...
        <div className="h-full w-full fixed top-0 left-0 bg-[#00000080] z-50 flex justify-center items-center">
          <div className="relative w-[560px] bg-white shadow-lg rounded-lg p-8 flex flex-col items-center">
            ...
            <div className="bg-[#e0ffc7] border border-[#b4d39b] w-[500px] p-6 mx-auto flex flex-col items-center">
              ...
              <a
                href="https://www.youtube.com/embed/9rXUgG_PtqQ"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#BD302B] text-white px-6 py-2 rounded hover:bg-red-700 transition duration-300"
              >
