...
const page = () => {
  ...
  const webinars = [
    {
      id: 6,
      title: "Key patient flow constructs in BREAST CANCER",
      slug: "estimating-bolus-patients",
      bgimageone: "/webinars/banner-image.png",
      titleone: "FORECAST MODELING",
      titlethree:
        "Breast Cancer is a complex disease. There are several disease types and subtypes making every patient’s journey unique.",
      titlefour:
        "It is critical to design a patient flow model that is comprehensive, dynamic, and clear.",
      ...
      about: {
        ...
        points: [
          ...
          "Key patient flow model design constructs​",
          "Identification of risk within Breast Cancer commercial assessments​",
        ],
        image: "/webinars/section2.png",
      },
      forecasting: [
        { header: "SPEAKERS" },
        ...
        {
          id: 2,
          image: "/webinars/Shruti-Gupta_WEB_large.jpg",
          name: "Shruti Gupta",
          role: "Director, Viscadia India",
          description:
            "Shruti leads forecasting and commercial assessment teams in our New Delhi, India office. She has more than 13 years of analytical consulting experience for the pharmaceutical and biotech industry",
          click: "Click to learn more >",
          link: "/shruti-gupta",
        },
        {
      ...
      webinarVideo: {
        ...
        image: "/webinars/image-31.webp",
        imgageone: "/webinars/image-31.webp",
    ...
    <div>
      {webinars.map((webinar, index) => (
        <div key={webinar.id || index}>
          <div className="flex mt-20 flex-col md:flex-row bg-white overflow-hidden relative">
            {/* Text Content Section */}
            <div className="flex-1 p-8 md:p-20 max-w-[640px] text-black font-light">
              <h3 className="text-xl md:text-[40px]  text-black font-light mb-4">
                {webinar.title}
              </h3>
              <h3 className="text-xl md:text-[28px] text-black font-light  mb-4">
                {webinar.titleone}
              </h3>
              <p className="text-base text-[#63666A] font-light leading-tight">
                {webinar.titlethree}
              </p>
              <p className="text-base text-[#63666A] pt-4 font-light leading-tight">
                {webinar.titlefour}
              </p>
              ...
              {webinar.buttonview && (
                <button
                  ...
                  className="mt-8 cursor-pointer bg-[#BD302B] text-white font-sans font-light text-[18px] px-[23px] py-[7px]"
                  type="button"
                >
                  {webinar.buttonview}
                </button>
          ...
          <div className="font-sans text-[#2e2e2e]">
            <img
              src="/webinars/section2.png"
              className="w-full block sm:hidden"
            />
            <section
              key={webinar.id}
              className="relative min-h-[400px] bg-white bg-cover bg-no-repeat bg-right-top sm:bg-left-top flex items-center"
          ...
          <div ref={formRef} className="webinarvideo mt-15 mb-15 text-center">
            ...
            {webinar.webinarVideo.image ? (
              <img
                ...
                className="w-[731px] h-[481px] mx-auto cursor-pointer"
          ...
          <div className="mt-[20px] mb-[30px] max-w-[1100px] mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 px-3 sm:px-0 mt-6 mb-48 justify-center">
              {/* Satish K. Kauta */}
                  ...
                  <div className="relative w-full h-[260px] group overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-[#BD302BB3] bg-opacity-70 text-white p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-between">
                      <p className="text-[14px] leading-4">
                        Satish is the Founder and CEO of Viscadia, with a career
                        spanning more than 25 years in the life sciences
                        industry. Having held forecasting leadership roles in
                        global life science companies such as Pfizer and Abbvie,
                        Satish also has deep experience in market research, new
                        product planning, and business development.
                      </p>
              ...
              {/* <div className="flex pb-3 hover:shadow-[0px_3px_6px_2px_rgba(0,_0,_0,_0.1)] flex-col items-center cursor-default">
                <div className="relative w-full h-[260px] group overflow-hidden">
                  <img
                    src="/webinars/Shruti-Gupta_WEB_large.jpg"
                    alt="Shruti Gupta"
              ...
              <div className="flex pb-3 hover:shadow-[0px_3px_6px_2px_rgba(0,_0,_0,_0.1)] flex-col items-center cursor-pointer">
                <div className="relative w-full h-[260px] group overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-[#BD302BB3] bg-opacity-70 text-white p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-between">
                    <p className="text-[14px] leading-4">
                      Shruti leads forecasting and commercial assessment teams
                      in our New Delhi, India office. She has more than 13 years
                      of analytical consulting experience for the pharmaceutical
        ...
        <div className="h-full w-full fixed top-0 left-0 bg-[#00000080] z-50 flex justify-center items-center">
          <div className="relative w-[560px] bg-white shadow-lg rounded-lg p-8 flex flex-col items-center">
            ...
            <div className="bg-[#e0ffc7] border border-[#b4d39b] w-[500px] p-6 mx-auto flex flex-col items-center">
              ...
              <a
                href="https://www.youtube.com/embed/bsW_NSY_JwE?si=JQ0OgXS2B_YDU860"
                target="_blank"
