...
const page = () => {
  ...
  const webinars = [
    {
      id: 3,
      title: "STRATEGIES FOR DEVELOPING SUCCESSFUL GLOBAL MED TECH FORECASTS",
      slug: "strategies-for-developing-successful-global-med-tech-forecasts",
      bgimageone: "/webinars/new-webinar3.png",
      titlethree:
        "Join us as we discuss the unique challenges in global forecasting for new medical technologies.",
      buttonview: "View Webinar",

      about: {
        title: "KEY TAKEAWAYS:",
        points: [
          "BUILD  ING A LONG RUN FORECAST – CAPTURING THE ROLE OF MARKET SHAPING INVESTMENTS ON PRODUCT ADOPTION AND PEAK MARKET SHARES.​",
          "IDENTIFY THE KEY FACTORS FOR DEVELOPING A SUCCESSFUL MED TECH FORECAST IN GLOBAL MARKETS.​",
        ],
        image: "/webinars/new-webinar2.png",
      },
      forecasting: [
        { header: "Speaker" },
      ...
      {webinars.map((webinar, index) => (
        <div key={webinar.id || index}>
          <div className="flex 2xl:max-w-[2100px] mx-auto flex-col-reverse sm:flex-row mt-20">
            <div className=" xl:mb-0 mb-3 unpakingwebinar md:max-w-[330px] lg:max-w-[525px]  xl:max-w-[680px] ">
              <h2 className="text-xl md:text-[24px] lg:text-[40px] font-light leading-8 lg:leading-12 mb-4">
                {webinar.title}
              </h2>
            ...
            <div>
              <img
                ...
                alt={webinar.title}
                className="w-full sm:h-[474px] sm:border-none border-2 border-gray-200 "
              />
            </div>
          </div>
          ...
          <div className="font-sans text-[#2e2e2e]">
            ...
            >
              <div className="container mx-auto px-6 sm:px-0 py-12 md:py-16">
        ...
        <div className="h-full w-full fixed top-0 left-0 bg-[#00000080] z-50 flex justify-center items-center">
          <div className="relative w-[560px] bg-white shadow-lg rounded-lg p-8 flex flex-col items-center">
            ...
            <div className="bg-[#e0ffc7] border border-[#b4d39b] w-[500px] p-6 mx-auto flex flex-col items-center">
              ...
              <a
                href="https://www.youtube.com/embed/K8eZn9Fkb-U?si=KRE-xQ8GL28qoKtn"
                target="_blank"
