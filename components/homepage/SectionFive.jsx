      ...
      <div className="forecastinghome md:max-w-6xl mx-auto sm:px-0 px-5">
        ...
        <div ref={ref}
          ...
          <div className="flex flex-col h-full justify-between">
            ...
            <p className="md:px-0 text-[16px] font-normal text-start md:text-[18px] tracking-wide md:leading-6 leading-snug mt-4 text-[#4E4E4E] md:font-light min-h-[auto] mb-3.5 md:mb-0 sm:min-h-[90px] max-w-[95%] md:max-w-[100%] md:text-center">
              Rapidly delivered an in-depth commercial assessment
            </p>
            <Link
              href="/case-studies"
              className="md:mx-auto mainBg text-white bg-[#bd302b] text-[16px] md:text-[14px] font-normal px-3 md:px-5 py-2.5 w-[36%] text-center md:w-[36.5%] md:text-center md:m-auto">
              READ MORE
            </Link>
          </div>
          ...
          <div className="flex flex-col h-full justify-between">
            ...
            <Link
              href="/case-studies"
              className="md:mx-auto mainBg text-white bg-[#bd302b] text-[16px] md:text-[14px] font-normal px-3 md:px-5 py-2.5 w-[30%] text-center md:w-[31.5%] md:text-center md:m-auto">
              SEE HOW
            </Link>
          </div>
          ...
          <div className="flex flex-col h-full justify-between">
            ...
            <Link
              href="/case-studies"
              className="md:mx-auto mainBg text-white bg-[#bd302b] text-[16px] md:text-[14px] font-normal px-3 md:px-5 py-2.5 w-[39%] text-center md:w-[39.5%] md:text-center md:m-auto">
              LEARN MORE
            </Link>
          </div>
        </div>
