...
const SectionOne = () => {
  return (
    <div>
      ...
      <div className="bg-[#F8F8F8] py-6 md:py-10 px-5 md:px-0">
        <p className="text-center text-[#BE302C] text-[18px] md:text-[20px] font-light">Forecasting is complex, but sometimes the answer is clear right from the start:</p>
        <h3 className="text-[20px] md:text-[26px] font-normal text-[#BE302C] text-center">Our communities need our support.</h3>
      </div>
    </div>
  );
};
