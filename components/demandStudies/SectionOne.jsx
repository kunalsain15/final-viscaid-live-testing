...
const SectionOne = () => {
  return (
    <div>
          ...
          <div className="w-full max-w-6xl mx-auto md:px-0 px-5 flex justify-start items-center">
            <div className="leading-[35px] md:leading-tight about_tab_align">
              ...
              <h3 className="text-[32px] md:text-[40px] lg:text-[40px] text-white sm:leading-14 font-light">
                Demand study solutions that <br></br>drive the forecast.
              </h3>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white h-[50px] flex sm:py-0 py-3 flex-wrap justify-center items-center gap-4 sm:gap-7">
        ...
        <Link
          ...
          className="text-sm mainColor font-light"
        >
